...
for network in  mynet_28 net_28 alex_28 dense_28
do
    for data in mnist
    do
...
do
    for data in mnist
    do
        for loss in OnlineContrastiveLossAllPositivePairSelector OnlineContrastiveLossHardNegativePairSelector OnlineTripletLossAllTripletSelector OnlineTripletLossHardestNegativeTripletSelector
        do
