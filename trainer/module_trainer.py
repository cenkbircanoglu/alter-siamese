...
def run():
    ...
    print(len(tr_data_loader), len(val_data_loader), len(te_data_loader))
    tr_loss = trainer.evaluate_loader(tr_data_loader, verbose=2, cuda_device=cuda_device)
    print(tr_loss)
    val_loss = trainer.evaluate_loader(val_data_loader, verbose=2, cuda_device=cuda_device)
    print(val_loss)
    te_loss = trainer.evaluate_loader(te_data_loader, verbose=2, cuda_device=cuda_device)
    print(te_loss)
