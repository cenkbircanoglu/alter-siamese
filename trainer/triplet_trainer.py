...
def run():
    ...
    save_embeddings(tr_y_pred, 'triplet/train_embeddings.csv')
    save_labels(tr_data_loader, 'triplet/train_labels.csv')

    val_y_pred = trainer.predict_loader(val_data_loader, cuda_device=cuda_device)
    save_embeddings(val_y_pred, 'triplet/val_embeddings.csv')
    save_labels(val_data_loader, 'triplet/val_labels.csv')

    te_y_pred = trainer.predict_loader(te_data_loader, cuda_device=cuda_device)
    save_embeddings(te_y_pred, 'triplet/test_embeddings.csv')
    save_labels(te_data_loader, 'triplet/test_labels.csv')
