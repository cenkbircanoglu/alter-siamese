...
files = glob(
    "/Users/cenk.bircanoglu/personal/Facial-Similarity-with-Siamese-Networks-in-Pytorch/data/utkface_age/part*/*.jpg")
...
for filename in files:
    try:
        ...
        print(e)
files = glob(
    "/Users/cenk.bircanoglu/personal/Facial-Similarity-with-Siamese-Networks-in-Pytorch/data/utkface_age_gender_race/part*/*.jpg")
