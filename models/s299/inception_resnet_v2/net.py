...
class InceptionResnetV2(nn.Module):
    def __init__(self, channel=3, embedding_size=1001, **kwargs):
        super(InceptionResnetV2, self).__init__()
        self.conv2d_1a = BasicConv2d(channel, 32, kernel_size=3, stride=2)
        ...
        self.classif = nn.Linear(1536, embedding_size)
